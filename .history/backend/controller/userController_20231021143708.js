...
const forgotPasswordToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await user.save();
        const resetURL = `Hi, Please follow this link to reset your password. This link is valid till 10 minutes from nom. <a href='http://localhost:6000/api/user/reset-password/${token}'>Click Here for more info.</a>`
